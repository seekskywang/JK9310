...
*/
//==============================================================================
#define GUI_BACKGROUND1          0x00FF0000   //5种背景色可供选择
#define GUI_BACKGROUND2          0x00FF0000
#define GUI_BACKGROUND3          0x00FF0000
#define GUI_BACKGROUND4          0x00FF0000
#define GUI_BACKGROUND5          0x00FF0000

#define GUI_FONTCOLOUR1          GUI_WHITE
#define GUI_FONTCOLOUR2          GUI_BLACK


#define GUI_CHOOSE1              GUI_WHITE
#define GUI_CHOOSE2              GUI_BLACK
#define GUI_CHOOSE3              GUI_WHITE
#define GUI_CHOOSE4              GUI_BLACK
#define GUI_CHOOSE15             GUI_WHITE
//#define GUI_CHOOSE2              GUI_BLACK

//#define GUI_BUTTON               0x00FF0000  //按键颜色
...
enum
{
	...
	CL_BLUE3        = RGB(  255, 68, 68),		/* 浅蓝色1 */
	CL_BLUE4        = RGB(  0, 64, 128),		/* 浅蓝色1 */
    CADETBLUE       =RGB(  0x4b, 0x3a, 0x25),//RGB( 60 ,0,  50),//(64,64,0)
    CADBUTTONLINE       =RGB( 8 ,44,  198),//(64,64,0)
    CADBUTTON       =RGB( 18 ,64,  218),//(64,64,0)
    CADBUTTON1       =RGB( 38 ,94,  248),//(64,64,0)
	/* UI 界面 Windows控件常用色 */
